...
training_args = PretrainingArguments(
    ...
    epoch=50,
    batch_size=48,
    model_storage_dir="models/pretraining_mlm/mixed_with_pretrained/bert_large_uncased",
    early_stop_count=5,
    addtional_model_config={"dropout": 0.3, "attention_dropout": 0.3},
    warm_up_steps=1000,
    tensorboard_log_dir="runs/pretraining_mlm/mixed_with_pretrained/bert_large_uncased/pretrain",
    span_only=False,
    mask_rate=0.15,
    gpu_device=0,
    load_weight=True,
