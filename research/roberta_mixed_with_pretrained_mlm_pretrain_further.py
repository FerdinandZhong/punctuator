...
training_args = PretrainingArguments(
    ...
    warm_up_steps=2000,
    tensorboard_log_dir="runs/pretraining_mlm/mixed_with_pretrained/roberta-large/pretrain",
    span_only=False,
    is_dynamic_mask=True,
    mask_rate=0.15,
    gpu_device=0,
    load_weight=True,
    current_plm_weights="models/pretraining_mlm/mixed_with_pretrained/roberta-large/no_prefix_space/whole_model.bin",
