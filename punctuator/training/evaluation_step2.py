...
from .general_ner_train_focal_loss_step2 import Step2EncodingDataset
...
class EvaluationArguments(BaseModel):
    ...
    evaluation_step1_features: List[List[int]]
    ...
    def add_cli_args(
        ...
        parser.add_argument(
            "--evaluation_step1_result_file_path",
            type=str,
            required=True,
            help="Path to training corpus file",
        )
...
class EvaluationPipeline:
    ...
    def tokenize(self):
        ...
        self.evaluation_encoded_step1_features = self._encode_step1_features(
            self.arguments.evaluation_step1_features,
            self.encodings,
            self.arguments.evaluation_corpus,
        )
